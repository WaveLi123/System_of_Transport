...
import listener.Select_Info_DialogListener;

public class Select_Info_Dialog extends JPanel {
...
//		jtfPhoneNum =new JTextField();
	...
	//	this.setLocation();
		...
		//com.sun.awt.AWTUtilities.setWindowShape(this, false);//关键代码！//设置窗体透明
...
//		jtfName.setBounds(133, 178, 150, 22);
		...
		Select_Info_DialogListener select_info_dialoglistener = new Select_Info_DialogListener(jtfName, jtfPhoneNum,
				jcbRoomType, ensure, cancel);
		
		ensure.addActionListener(select_info_dialoglistener);
		cancel.addActionListener(select_info_dialoglistener);
