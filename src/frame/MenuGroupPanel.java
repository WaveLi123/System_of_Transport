...
public class MenuGroupPanel extends JPanel{
	...
	public MenuGroupPanel(){
		...
		bt_book=new ImageButton("bt_menu","添加",57);
		bt_taken=new ImageButton("bt_menu","修改",57);
		bt_handRoom=new ImageButton("bt_menu","删除",57);
		bt_set=new ImageButton("bt_menu","设置",57);
		bt_inf=new ImageButton("bt_menu","查询",57);
