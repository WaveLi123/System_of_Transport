...
public class Deleteinfo_Bus extends JPanel {
	...
	public Deleteinfo_Bus(){
		...
		jtfcapatify.setEditable(false);
		jtfroutenumber.setEditable(false);		
		...
		cancel.setBounds(410, 200, 48, 48);
			...
			public void actionPerformed(ActionEvent e) {
				if(jtftype.getText().equalsIgnoreCase("") 
					...
					try {
						bus.deleteDB(jtfnumber.getText());	
					...
					MainFrame.instance().closeDeleteinfo_Bus();
				}				
			}			
		});
