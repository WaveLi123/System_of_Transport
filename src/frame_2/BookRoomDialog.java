...
import dao.RoomTypeData;

import listener_2.BookRoomDialogListener;
...
public class BookRoomDialog extends JPanel {
	...
	public BookRoomDialog(){
		...
		Object[] obj = RoomTypeData.instance().FormatRoomTypeName();
	...
	//	jtfPhoneNum.setOpaque(false);
		...
		BookRoomDialogListener bookRoomDialogListener= new BookRoomDialogListener(jtfName, jtfPhoneNum,
