...
public class BookingPanelListener implements ActionListener{
	...
	private JTextField jtfName,jtfAge,jtfPhoneNum,jtfIdNum,jtfHomeAdress,jtfWordPlace,jtfRoomId,jtfDeposit;
	...
	public BookingPanelListener(JTextField jtfName, JTextField jtfAge,
			...
			JTextField jtfRoomId, JTextField jtfDeposit, JRadioButton jrbMal,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == bt_back) {
			...
			if(jtfName.getText().equals("") ||
				...
				int roomId =Integer.parseInt(jtfRoomId.getText());
